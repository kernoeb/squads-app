...
class CalendarApi
    ...
    constructor(
        ...
        suspend fun getEvents(
            ...
            val start = startDate.atStartOfDay(zone).format(DateTimeFormatter.ISO_INSTANT)
            val end = startDate.plusDays(days.toLong()).atStartOfDay(zone).format(DateTimeFormatter.ISO_INSTANT)
